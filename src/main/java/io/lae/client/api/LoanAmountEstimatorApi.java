...
public class LoanAmountEstimatorApi {
    ...
    public okhttp3.Call getLAEByPersonCall(String xApiKey, String username, String password, PeticionPersona request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;
    ...
    private okhttp3.Call getLAEByPersonValidateBeforeCall(String xApiKey, String username, String password, PeticionPersona request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        if (xApiKey == null) {
            throw new ApiException("Missing the required parameter 'xApiKey' when calling getLAEByPerson(Async)");
        }
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling getLAEByPerson(Async)");
        }
        if (password == null) {
            throw new ApiException("Missing the required parameter 'password' when calling getLAEByPerson(Async)");
        }
    ...
    public ApiResponse<Respuesta> getLAEByPersonWithHttpInfo(String xApiKey, String username, String password, PeticionPersona request) throws ApiException {
