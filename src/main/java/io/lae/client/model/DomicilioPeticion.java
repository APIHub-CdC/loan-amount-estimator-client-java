...
import io.lae.client.model.CatalogoTipoAsentamiento;
import io.lae.client.model.CatalogoTipoDomicilio;
...
public class DomicilioPeticion {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(direccion, coloniaPoblacion, delegacionMunicipio, ciudad, estado, CP, fechaResidencia, numeroTelefono, tipoDomicilio, tipoAsentamiento, pais);
  }
  @Override
